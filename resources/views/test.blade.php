        ...
        <div class="row">
          <div class="col-md-2 t">
            <select class="dropdown" tabindex="7">
              <option value="1">По участкам</option>
              <option value="2">По кандидатам</option>
            </select> 
          </div>
          <div class="col-md-8 t">2</div>
          <div class="col-md-2 t">3</div>
        </div>
      </div>
    </div>
    <div class="row mt40">
...
<!-- <div class="container c">
  <div class="row ">
    <div class="col-sm-2 t">1</div>
    <div class="col-sm-8 mr-auto ml-auto t">2</div>
    <div class="col-sm-2 t">3</div>
  </div>
</div>
<br> -->
