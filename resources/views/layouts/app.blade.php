            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto word_stl">
                        <li><a class="nav-link head_nav_stl" href="{{ url('/') }}"><i class="fa fa-search"></i> Поиск</a></li>
                        <li><a class="nav-link head_nav_stl" href="{{ url('/') }}"><i class="fas fa-map-marker-alt"></i> Череповец <i class="fas fa-caret-down"></i></a></li>
                       ...
                       <li class="nav-item dropdown"> 
                            <a class="nav-link dropdown-toggle drop_lk" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-user-circle"></i> Личный кабинет <span class="caret"></span>
                            </a>
                            <div class="dropdown-menu drop_stl word_stl" aria-labelledby="navbarDropdown">
                                <div class="row">
                                    <div class="col-md-8 col-md-ofset-2 top-cover text-center">
                                    <span class="text-center word_stl3 lk_in">Вход</span>
                                    <br>
                                    <div class="fastin row">
                                        <div class="col-md-6 top-cover text-center">
                                            <span class="text-center">Быстрый вход</span>
                                        </div>
                                        <div class="col-md-2 top-cover text-center">
                                            <div class="bor_f">
                                                <a href="/" class="soc_ico"><i class="fab fa-facebook-f"></i></a>
                                            </div>
                                        </div>
                                        <div class="col-md-4 top-cover text-center">
                                            <div class="bor_vk">
                                    ...
                                    <hr>
                                    <a href="/">Зарегистрироваться <i class="fas fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </li>
