...
@section('content')
    ...
    <div class="lk_menu_list ">
        <div class="text-left text_lk ">
            <form action="{{ URL::to('personal/update') }}" method="POST">
                ...
                <div class="hide_pass_div mt-5 mb-5" id="pass_div">
                    <input type="password" class="form-control inpt_lk mb-4 " id="password_old" placeholder="Старый пароль">
                    <input type="password" class="form-control inpt_lk mb-4 " id="password_new" placeholder="Новый пароль">
                    <input type="password" class="form-control inpt_lk mb-4" id="password_re" placeholder="Повотрите пароль">
                    <button type="button" class="btn btn-danger bnt_save_lk mt-4" id="bnt_change_pass">Изменить</button>
                    <div id="data_pass_div"></div>
                </div>
                <br>
        ...
        <div class="text-left text_lk ">
            ...
            <p class="">Паспорт</p>
            <form action="{{ URL::to('personal/update2') }}" method="POST">
                {{ csrf_field() }}
                <div class="row">
                ...
                <br>
                <button type="button" class="btn btn-danger bnt_save_lk" id="save_date2_lk">Отправить</button>
                <div id="data_div2" class="pb-5"></div>
            </form>
        </div>
    </div>
    @else
        <div class="lk_menu_list2 pr-5 pl-4">
            <div class="text-left text_lk ">
                ...
                <form action="{{ URL::to('personal/update') }}" method="POST">
                    ...
                    <br>
                    <button type="button" class="btn btn-danger bnt_save_lk" id="save_date_lk">Сохранить</button>
                    <div id="data_div" class="pb-3"></div>
                </form>
            </div>
        </div>
@endif
